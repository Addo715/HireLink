        ...
        <div className="w-full max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-between gap-y-12 lg:gap-x-8">
            ...
            <div className="w-full md:w-[45%] lg:w-[35%] flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <p className="text-sm text-white/60 mt-6 max-w-sm leading-relaxed">
                HireLink is a modern job marketplace connecting talented
                professionals with trusted companies across multiple career
                paths.
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-white/60 max-w-2xl text-center md:text-right">
              HireLink is a hiring platform. We do not guarantee employment or
              job placement. Employers are responsible for their listings and
              hiring decisions.
            </p>
          </div>
        </div>
