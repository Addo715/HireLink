...
• Expert proficiency in Figma, Sketch, or Adobe Creative Suite
...
• Experience working in an agency or fast-paced environment
...
• Manage SEO, SEM, and social media marketing campaigns
...
• Collaborate with clients to understand business objectives
...
• Full benefits package including health and retirement
...
Key Responsibilities:
• Lead end-to-end project management for software development initiatives
• Define project scope, goals, and deliverables in collaboration with stakeholders
• Develop detailed project plans and resource allocation strategies
• Facilitate Agile ceremonies including daily standups, sprint planning, and retrospectives
• Monitor project progress and adjust plans as needed
• Manage risks, issues, and dependencies proactively
• Communicate project status to stakeholders at all levels
• Foster a collaborative team environment and mentor team members

Requirements:
• 8+ years of project management experience in software development
• PMP, CSM, or equivalent certification required
• Expert knowledge of Agile/Scrum methodologies
...
• Automate reporting processes and improve data workflows
• Present findings and recommendations to stakeholders
• Maintain data quality and documentation standards

Requirements:
• 4+ years of experience in data analysis
• Strong proficiency in SQL and Python (pandas, NumPy)
...
• Strong proficiency in modern JavaScript/TypeScript and frameworks (React, Node.js)
...
• Stay current with content marketing best practices

Requirements:
• 5+ years of professional writing experience
• Strong portfolio of B2B and technical content
...
• Debug and fix issues reported by users and QA team
...
• Experience with iOS and/or Android native development
• Knowledge of mobile UI/UX design principles
• Familiarity with state management (Redux, MobX, Provider)
• Experience with API integration and asynchronous programming
• Understanding of mobile app architecture and design patterns
• Experience with version control (Git) and code collaboration
• Portfolio of published mobile applications
• Bachelor's degree in Computer Science or related field

What We Offer:
• Competitive salary and benefits
• Work on high-impact mobile applications
• Latest Apple devices and development tools
• Professional development opportunities
• Flexible work arrangements
...
• Create and maintain automated test scripts using Selenium, Cypress, or similar tools
...
Requirements:
• 6+ years of QA engineering experience
...
• Experience with CI/CD and test integration
